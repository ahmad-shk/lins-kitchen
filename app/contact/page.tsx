    ...
    <main>
        ...
        <div className='container-sm'>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
            <div>
              ...
              <p className='font-semibold text-xl'>MO: Ruhetag<br />DI - SO: 11:30 - 14:30 und 17:30 - 22:00<br />Feiertag: 11:30 - 14:30 und 17:30 - 22:00</p>
            </div>
            <div>
      ...
      <div className='container-sm'>
        <div className='text-center py-20'>
          ...
          <p className='text-xl md:text-3xl text-black mt-7'>Route planen in Google Maps</p>
        </div>
      </div>
    </main>
  )
