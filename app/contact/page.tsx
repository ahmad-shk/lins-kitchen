        ...
        <div className='container-sm'>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
            <div>
              ...
              <p className='font-normal text-lg'>MO: Ruhetag<br />DI - SO: 11:30 - 14:30 und 17:30 - 22:00<br />Feiertag: 11:30 - 14:30 und 17:30 - 22:00</p>
            </div>
            <div>
              <h4 className='font-playfair font-semibold text-2xl md:text-3xl mb-2'>Adresse</h4>
              <p className='font-normal text-lg'>KETZERGASSE 299 <br />2380 PERCHTOLDSDORF</p>
            </div>
            <div>
              <h4 className='font-playfair font-semibold text-2xl md:text-3xl whitespace-nowrap mb-2'>E-Mail und Telefon</h4>
              <p className='font-normal text-lg mb-2'>Phone: 01 / 88 99 308</p>
              <p className='font-normal text-lg'>Email: office@lins-kitchen.at</p>
            </div>
          </div>
