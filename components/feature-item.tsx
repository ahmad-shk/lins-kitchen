      ...
      <div className='container-sm relative'>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="">
            ...
            <p className="font-inter italic text-[15px] leading-tight">Mittagsmenüs am Samstag,Sonntag und an Feiertagen  sind gegen einen Aufpreis von 2,00 € erhältlich.</p>
          </div>
        </div>
      </div>
    </div>
